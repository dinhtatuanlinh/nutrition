...
<header id="header" style="background-image: url(''); background-repeat: no-repeat; background-size: cover;">
    ...
    <ul class="icons">
        <li><a href="<?php echo $aboutData['youtube']; ?>" class="icon brands fa-youtube dttlyoutube"><span
                    class="label">youtube</span></a></li>
        <li><a href="<?php echo $aboutData['facebook']; ?>" class="icon brands fa-facebook-f dttlfacebook"><span
